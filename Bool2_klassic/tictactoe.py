...
class TTTBoard(Board):
    ...
    def __repr__(self):
        return f"""'{self. position[0]} 1 {self. position[1]} 1 {self. position[2]}
            {self.position[3]}1{self.position[4]}1{self.position[5]}
            {self.position[6]}1{self.position[7]}1{self.position[8]}"""
