...
class TTTMinimaxTestCase(unittest.TestCase):
    def test_easy_position(self):
        to_win_easy_position=[TTTPiece.X, TTTPiece.O,TTTPiece.X,TTTPiece.X,TTTPiece.E,
                              TTTPiece.O,TTTPiece.E,TTTPiece.E,TTTPiece.O]
    ...
    def test_block_position(self):
        to_win_block_position=[TTTPiece.X, TTTPiece.E,TTTPiece.E,TTTPiece.E,TTTPiece.E,
                              TTTPiece.O,TTTPiece.E,TTTPiece.X,TTTPiece.O]
        test_board2=TTTBoard(to_win_block_position, TTTPiece.X)
        answer2=find_best_move(test_board2)
        self.assertEqual(answer2,2)
    def test_hard_position(self):
        to_win_hard_position=[TTTPiece.X, TTTPiece.E,TTTPiece.E,TTTPiece.E,TTTPiece.E,
