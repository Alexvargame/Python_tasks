...
class child_edit_gost_info():
   def __init__(self, child_report_search, temp_):
    ...
    global FloorString, FloorsString, PriceString, SquareString, DateString, Text_infoString, IdString, AuthorString
    ...
    ent_text_info.grid(row=6, column=1)
   ...
   def edit_stat(self):
      ...
      if self.returnValue:   
        ...
        a = Gostinki(IdString.get(), AuthorString.get(), DateString, TypesString.get(), AdressCityString.get(),
                         ...
                         PriceString.get(), Text_infoString.get())
